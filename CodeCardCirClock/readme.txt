CodeCard Circle Clock

This application is based on the Oracle CodeCard Hardware which is an ESP8266 base device with an ePaper display.

The numbers in the middle digits represents the minutes and the circles surrounding represents the hours.
...
The digits are bitmaps stored in NumFont.h file and created with the Dot Factory (http://www.eran.io/the-dot-factory-an-lcd-font-and-image-generator/)
