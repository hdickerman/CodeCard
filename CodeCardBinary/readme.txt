CodeCard Binary Clock

This application is based on the Oracle CodeCard Hardware which is an ESP8266 base device with an ePaper display.

The binary digits represent hours, minutes (tens), and minutes (ones)
There are two styles set in the configuration: stacked dots and concentric circles
